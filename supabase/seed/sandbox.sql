...
INSERT INTO public.business_units (
  ...
  ('b0010001-0001-0001-0001-000000000001', 'India Sales', 'e0000001-0001-0001-0001-000000000001', 'sales', NULL, NULL, true, '{"test":"bu_india_sales"}'::jsonb),
  ...
  ('b00000e1-00e1-00e1-00e1-0000000000e1', 'East Asia', 'e0000001-0001-0001-0001-000000000001', 'sales', NULL, NULL, true, '{"test":"bu_east_asia"}'::jsonb),
  ('b00000e2-00e2-00e2-00e2-0000000000e2', 'East Asia Ops', 'e0000001-0001-0001-0001-000000000001', 'ops', NULL, NULL, true, '{"test":"bu_east_asia_ops"}'::jsonb),
  ('b00000a1-00a1-00a1-00a1-0000000000a1', 'Trimax', 'e0000007-0007-0007-0007-000000000007', 'sales', NULL, NULL, true, '{"test":"bu_trimax"}'::jsonb),
  ('b00000c1-00c1-00c1-00c1-0000000000c1', 'Sages', 'e0000005-0005-0005-0005-000000000005', 'sales', NULL, NULL, true, '{"test":"bu_sages"}'::jsonb),
  ...
  ('b00000ff-00ff-00ff-00ff-0000000000ff', 'Inactive BU', 'e0000001-0001-0001-0001-000000000001', 'sales', NULL, NULL, false, '{"test":"bu_inactive"}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO public.users (
  ...
  ('a0000001-0001-0001-0001-000000000001', 'alice.admin@nodwin-test.example', 'Alice Admin', 'admin', 'e0000001-0001-0001-0001-000000000001', 'b0010001-0001-0001-0001-000000000001', NULL),
  ('a0000002-0002-0002-0002-000000000002', 'bob.manager@nodwin-test.example', 'Bob Manager', 'sales_manager', 'e0000001-0001-0001-0001-000000000001', 'b0010001-0001-0001-0001-000000000001', 'a0000001-0001-0001-0001-000000000001'),
  ('a0000003-0003-0003-0003-000000000003', 'charlie.rep@nodwin-test.example', 'Charlie Rep', 'sales_rep', 'e0000001-0001-0001-0001-000000000001', 'b0010001-0001-0001-0001-000000000001', 'a0000002-0002-0002-0002-000000000002'),
...
INSERT INTO public.opportunities (
  ...
  ('d0000001-0001-0001-0001-000000000001', 'Q1 Enterprise Deal - Acme', 'c0000001-0001-0001-0001-000000000001', 'qualify', 10,
   'a0000003-0003-0003-0003-000000000003', 'b0010001-0001-0001-0001-000000000001',
  ...
  ('d0000002-0002-0002-0002-000000000002', 'Spring Campaign - Test Industries', 'c0000002-0002-0002-0002-000000000002', 'qualify', 10,
   'a0000004-0004-0004-0004-000000000004', 'b0020001-0001-0001-0001-000000000001',
  ...
  ('d0000003-0003-0003-0003-000000000003', 'Beta Gaming Tournament Sponsorship', 'c0000003-0003-0003-0003-000000000003', 'qualify', 10,
   'a0000003-0003-0003-0003-000000000003', 'b00000e1-00e1-00e1-00e1-0000000000e1',
  ...
  ('d0000004-0004-0004-0004-000000000004', 'Gamma Media Fest 2026', 'c0000004-0004-0004-0004-000000000004', 'qualify', 10,
   'a0000002-0002-0002-0002-000000000002', 'b0030001-0001-0001-0001-000000000001',
  ...
  ('d0000006-0006-0006-0006-000000000006', 'Epsilon Esports League Partnership', 'c0000006-0006-0006-0006-000000000006', 'qualify', 15,
   'a0000004-0004-0004-0004-000000000004', 'b0070001-0001-0001-0001-000000000001',
  ...
  ('d0000007-0007-0007-0007-000000000007', 'Zeta Productions Series A', 'c0000007-0007-0007-0007-000000000007', 'qualify', 10,
   'a0000002-0002-0002-0002-000000000002', 'b00000c1-00c1-00c1-00c1-0000000000c1',
  ...
  ('d0010007-0007-0007-0007-000000000007', 'Iota Interactive Digital Campaign', 'c0000010-0010-0010-0010-000000000010', 'propose', 40,
   'a0000003-0003-0003-0003-000000000003', 'b0030001-0001-0001-0001-000000000001',
  ...
  ('d0010008-0008-0008-0008-000000000008', 'Theta Broadcasting Rights Package', 'c0000009-0009-0009-0009-000000000009', 'propose', 50,
   'a0000002-0002-0002-0002-000000000002', 'b0080001-0001-0001-0001-000000000001',
  ...
  ('d0020005-0005-0005-0005-000000000005', 'Iota Interactive MEA Expansion', 'c0000010-0010-0010-0010-000000000010', 'verbal_agreement', 90,
   'a0000003-0003-0003-0003-000000000003', 'b0080001-0001-0001-0001-000000000001',
