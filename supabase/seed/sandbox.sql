...
INSERT INTO public.entities (
  ...
  ('e000000a-0010-0010-0010-000000000010', 'Comic Con', 'Comic Con India Pvt Ltd', 'IN', 'INR', 4, true, '{"timezone":"Asia/Kolkata","region":"APAC"}'::jsonb, 'Comic Con India', NULL, NULL)
...
INSERT INTO public.business_units (
  ...
  ('b0002711-0001-0001-0001-000000000001', 'India Sales', 'e0000001-0001-0001-0001-000000000001', 'sales', NULL, NULL, true, '{"test":"bu_india_sales"}'::jsonb),
  ('b0002712-0002-0002-0002-000000000002', 'India Ops', 'e0000001-0001-0001-0001-000000000001', 'ops', NULL, NULL, true, '{"test":"bu_india_ops"}'::jsonb),
  ('b0002713-0003-0003-0003-000000000003', 'India RevRec', 'e0000001-0001-0001-0001-000000000001', 'revenue_recognition', NULL, NULL, true, '{"test":"bu_india_revrec"}'::jsonb),
  ('b0004e21-0001-0001-0001-000000000001', 'NG Spr Sales', 'e0000002-0002-0002-0002-000000000002', 'sales', NULL, NULL, true, '{"test":"bu_spr_sales"}'::jsonb),
  ('b0004e22-0002-0002-0002-000000000002', 'NG Spr RevRec', 'e0000002-0002-0002-0002-000000000002', 'revenue_recognition', NULL, NULL, true, '{"test":"bu_spr_revrec"}'::jsonb),
  ...
  ('b0000031-0031-0031-0031-003100310031', 'Trimax', 'e0000007-0007-0007-0007-000000000007', 'sales', NULL, NULL, true, '{"test":"bu_trimax"}'::jsonb),
  ('b0000021-0021-0021-0021-002100210021', 'Sages', 'e0000005-0005-0005-0005-000000000005', 'sales', NULL, NULL, true, '{"test":"bu_sages"}'::jsonb),
  ('b0007531-0001-0001-0001-000000000001', 'Unpause Sales', 'e0000003-0003-0003-0003-000000000003', 'sales', NULL, NULL, true, '{"test":"bu_unpause_sales"}'::jsonb),
  ('b0009c41-0001-0001-0001-000000000001', 'PSH Sales', 'e0000004-0004-0004-0004-000000000004', 'sales', NULL, NULL, true, '{"test":"bu_psh_sales"}'::jsonb),
  ('b0011171-0001-0001-0001-000000000001', 'Branded Sales', 'e0000007-0007-0007-0007-000000000007', 'sales', NULL, NULL, true, '{"test":"bu_branded_sales"}'::jsonb),
  ('b0013881-0001-0001-0001-000000000001', 'MENA Sales', 'e0000008-0008-0008-0008-000000000008', 'sales', NULL, NULL, true, '{"test":"bu_mena_sales"}'::jsonb),
  ('b0015f91-0001-0001-0001-000000000001', 'Starladder Sales', 'e0000009-0009-0009-0009-000000000009', 'sales', NULL, NULL, true, '{"test":"bu_starladder_sales"}'::jsonb),
  ('b00186a1-0001-0001-0001-000000000001', 'Comic Con Sales', 'e000000a-0010-0010-0010-000000000010', 'sales', NULL, NULL, true, '{"test":"bu_comiccon_sales"}'::jsonb),
...
INSERT INTO public.users (
  ...
  ('a0000001-0001-0001-0001-000000000001', 'alice.admin@nodwin-test.example', 'Alice Admin', 'admin', 'e0000001-0001-0001-0001-000000000001', 'b0002711-0001-0001-0001-000000000001', NULL),
  ('a0000002-0002-0002-0002-000000000002', 'bob.manager@nodwin-test.example', 'Bob Manager', 'sales_manager', 'e0000001-0001-0001-0001-000000000001', 'b0002711-0001-0001-0001-000000000001', 'a0000001-0001-0001-0001-000000000001'),
  ('a0000003-0003-0003-0003-000000000003', 'charlie.rep@nodwin-test.example', 'Charlie Rep', 'sales_rep', 'e0000001-0001-0001-0001-000000000001', 'b0002711-0001-0001-0001-000000000001', 'a0000002-0002-0002-0002-000000000002'),
  ('a0000004-0004-0004-0004-000000000004', 'diana.rep@nodwin-test.example', 'Diana Rep', 'sales_rep', 'e0000002-0002-0002-0002-000000000002', 'b0004e21-0001-0001-0001-000000000001', 'a0000002-0002-0002-0002-000000000002'),
  ('a0000005-0005-0005-0005-000000000005', 'eva.finance@nodwin-test.example', 'Eva Finance', 'finance', 'e0000001-0001-0001-0001-000000000001', 'b0002713-0003-0003-0003-000000000003', 'a0000001-0001-0001-0001-000000000001')
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO public.accounts (
  ...
  ('c000000a-0010-0010-0010-000000000010', 'Iota Interactive Media', 'Iota Interactive Media FZ-LLC', 'https://iota-test.example', 'AE', 'media', 'Fake seed account.', 'a0000003-0003-0003-0003-000000000003', '{"test":"seed_account_10"}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name, legal_name = EXCLUDED.legal_name,
...
INSERT INTO public.opportunities (
  ...
  ('d0000001-0001-0001-0001-000000000001', 'Q1 Enterprise Deal - Acme', 'c0000001-0001-0001-0001-000000000001', 'qualify', 10,
   'a0000003-0003-0003-0003-000000000003', 'a0000003-0003-0003-0003-000000000003', 'b0002711-0001-0001-0001-000000000001',
  ...
  ('d0000002-0002-0002-0002-000000000002', 'Spring Campaign - Test Industries', 'c0000002-0002-0002-0002-000000000002', 'qualify', 10,
   'a0000004-0004-0004-0004-000000000004', 'a0000004-0004-0004-0004-000000000004', 'b0004e21-0001-0001-0001-000000000001',
  ...
  ('d0000004-0004-0004-0004-000000000004', 'Gamma Media Fest 2026', 'c0000004-0004-0004-0004-000000000004', 'qualify', 10,
   'a0000002-0002-0002-0002-000000000002', 'a0000002-0002-0002-0002-000000000002', 'b0007531-0001-0001-0001-000000000001',
  ...
  ('d0000006-0006-0006-0006-000000000006', 'Epsilon Esports League Partnership', 'c0000006-0006-0006-0006-000000000006', 'qualify', 15,
   'a0000004-0004-0004-0004-000000000004', 'a0000004-0004-0004-0004-000000000004', 'b0011171-0001-0001-0001-000000000001',
  ...
  ('d0000007-0007-0007-0007-000000000007', 'Zeta Productions Series A', 'c0000007-0007-0007-0007-000000000007', 'qualify', 10,
   'a0000002-0002-0002-0002-000000000002', 'a0000002-0002-0002-0002-000000000002', 'b0000021-0021-0021-0021-002100210021',
  ...
  ('d0002710-0000-0000-0000-000000000000', 'Test Industries Product Launch', 'c0000002-0002-0002-0002-000000000002', 'meet_and_present', 30,
   'a0000004-0004-0004-0004-000000000004', 'a0000004-0004-0004-0004-000000000004', 'b0004e21-0001-0001-0001-000000000001',
  ...
  ('d0002711-0001-0001-0001-000000000001', 'Beta Gaming Seasonal Pass', 'c0000003-0003-0003-0003-000000000003', 'meet_and_present', 20,
   'a0000003-0003-0003-0003-000000000003', 'a0000003-0003-0003-0003-000000000003', 'b00000e1-00e1-00e1-00e1-00e100e100e1',
  ...
  ('d0002712-0002-0002-0002-000000000002', 'Gamma Ramadan Campaign', 'c0000004-0004-0004-0004-000000000004', 'meet_and_present', 25,
   'a0000002-0002-0002-0002-000000000002', 'a0000002-0002-0002-0002-000000000002', 'b0007531-0001-0001-0001-000000000001',
  ...
  ('d0002713-0003-0003-0003-000000000003', 'Delta Entertainment Studio Deal', 'c0000005-0005-0005-0005-000000000005', 'meet_and_present', 35,
   'a0000003-0003-0003-0003-000000000003', 'a0000003-0003-0003-0003-000000000003', 'b0002711-0001-0001-0001-000000000001',
  ...
  ('d0002714-0004-0004-0004-000000000004', 'Epsilon Esports Merch Deal', 'c0000006-0006-0006-0006-000000000006', 'propose', 40,
   'a0000004-0004-0004-0004-000000000004', 'a0000004-0004-0004-0004-000000000004', 'b0011171-0001-0001-0001-000000000001',
  ...
  ('d0002715-0005-0005-0005-000000000005', 'Zeta Productions Studio B', 'c0000007-0007-0007-0007-000000000007', 'propose', 45,
   'a0000002-0002-0002-0002-000000000002', 'a0000002-0002-0002-0002-000000000002', 'b0000021-0021-0021-0021-002100210021',
  ...
  ('d0002716-0006-0006-0006-000000000006', 'Acme Corp Influencer Programme', 'c0000001-0001-0001-0001-000000000001', 'propose', 50,
   'a0000003-0003-0003-0003-000000000003', 'a0000003-0003-0003-0003-000000000003', 'b0002711-0001-0001-0001-000000000001',
  ...
  ('d0002717-0007-0007-0007-000000000007', 'Iota Interactive Digital Campaign', 'c000000a-0010-0010-0010-000000000010', 'propose', 40,
   'a0000003-0003-0003-0003-000000000003', 'a0000003-0003-0003-0003-000000000003', 'b0007531-0001-0001-0001-000000000001',
  ...
  ('d0002718-0008-0008-0008-000000000008', 'Theta Broadcasting Rights Package', 'c0000009-0009-0009-0009-000000000009', 'propose', 50,
   'a0000002-0002-0002-0002-000000000002', 'a0000002-0002-0002-0002-000000000002', 'b0013881-0001-0001-0001-000000000001',
  ...
  ('d0002719-0009-0009-0009-000000000009', 'Epsilon Esports Content Hub', 'c0000006-0006-0006-0006-000000000006', 'negotiate', 60,
   'a0000004-0004-0004-0004-000000000004', 'a0000004-0004-0004-0004-000000000004', 'b0011171-0001-0001-0001-000000000001',
  ...
  ('d0004e20-0000-0000-0000-000000000000', 'Beta Gaming Season 3', 'c0000003-0003-0003-0003-000000000003', 'negotiate', 55,
   'a0000003-0003-0003-0003-000000000003', 'a0000003-0003-0003-0003-000000000003', 'b00000e1-00e1-00e1-00e1-00e100e100e1',
  ...
  ('d0004e21-0001-0001-0001-000000000001', 'Acme Corp Global Tour', 'c0000001-0001-0001-0001-000000000001', 'negotiate', 65,
   'a0000003-0003-0003-0003-000000000003', 'a0000003-0003-0003-0003-000000000003', 'b0002711-0001-0001-0001-000000000001',
  ...
  ('d0004e22-0002-0002-0002-000000000002', 'Test Industries H2 Roadmap', 'c0000002-0002-0002-0002-000000000002', 'negotiate', 60,
   'a0000004-0004-0004-0004-000000000004', 'a0000004-0004-0004-0004-000000000004', 'b0004e21-0001-0001-0001-000000000001',
  ...
  ('d0004e23-0003-0003-0003-000000000003', 'Delta Entertainment Festival Series', 'c0000005-0005-0005-0005-000000000005', 'verbal_agreement', 80,
   'a0000003-0003-0003-0003-000000000003', 'a0000003-0003-0003-0003-000000000003', 'b0002711-0001-0001-0001-000000000001',
  ...
  ('d0004e24-0004-0004-0004-000000000004', 'Zeta Productions Live Stream Deal', 'c0000007-0007-0007-0007-000000000007', 'verbal_agreement', 85,
   'a0000002-0002-0002-0002-000000000002', 'a0000002-0002-0002-0002-000000000002', 'b0000021-0021-0021-0021-002100210021',
  ...
  ('d0004e25-0005-0005-0005-000000000005', 'Iota Interactive MEA Expansion', 'c000000a-0010-0010-0010-000000000010', 'verbal_agreement', 90,
   'a0000003-0003-0003-0003-000000000003', 'a0000003-0003-0003-0003-000000000003', 'b0013881-0001-0001-0001-000000000001',
  ...
  ('d0004e26-0006-0006-0006-000000000006', 'Acme Corp Legacy Deal', 'c0000001-0001-0001-0001-000000000001', 'closed_won', 100,
   'a0000003-0003-0003-0003-000000000003', 'a0000003-0003-0003-0003-000000000003', 'b0002711-0001-0001-0001-000000000001',
  ...
  ('d0004e27-0007-0007-0007-000000000007', 'Beta Gaming Q1 Campaign', 'c0000003-0003-0003-0003-000000000003', 'closed_won', 100,
   'a0000003-0003-0003-0003-000000000003', 'a0000003-0003-0003-0003-000000000003', 'b00000e1-00e1-00e1-00e1-00e100e100e1',
  ...
  ('d0004e28-0008-0008-0008-000000000008', 'Test Industries Partnership 2025', 'c0000002-0002-0002-0002-000000000002', 'closed_won', 100,
   'a0000004-0004-0004-0004-000000000004', 'a0000004-0004-0004-0004-000000000004', 'b0004e21-0001-0001-0001-000000000001',
  ...
  ('d0004e29-0009-0009-0009-000000000009', 'Gamma Media Rejected Proposal', 'c0000004-0004-0004-0004-000000000004', 'closed_lost', 0,
   'a0000002-0002-0002-0002-000000000002', 'a0000002-0002-0002-0002-000000000002', 'b0007531-0001-0001-0001-000000000001',
  ...
  ('d0007530-0000-0000-0000-000000000000', 'Eta Digital Budget Cut', 'c0000008-0008-0008-0008-000000000008', 'closed_lost', 0,
   'a0000004-0004-0004-0004-000000000004', 'a0000004-0004-0004-0004-000000000004', 'b0004e21-0001-0001-0001-000000000001',
...
INSERT INTO public.opportunity_team_members (
  ...
  ('f000000a-0010-0010-0010-000000000010', 'd0002710-0000-0000-0000-000000000000', 'a0000004-0004-0004-0004-000000000004', 'owner'),
  ('f000000b-0011-0011-0011-000000000011', 'd0002711-0001-0001-0001-000000000001', 'a0000003-0003-0003-0003-000000000003', 'owner'),
  ('f000000c-0012-0012-0012-000000000012', 'd0002712-0002-0002-0002-000000000002', 'a0000002-0002-0002-0002-000000000002', 'owner'),
  ('f000000d-0013-0013-0013-000000000013', 'd0002713-0003-0003-0003-000000000003', 'a0000003-0003-0003-0003-000000000003', 'owner'),
  ('f000000e-0014-0014-0014-000000000014', 'd0002714-0004-0004-0004-000000000004', 'a0000004-0004-0004-0004-000000000004', 'owner'),
  ('f000000f-0015-0015-0015-000000000015', 'd0002715-0005-0005-0005-000000000005', 'a0000002-0002-0002-0002-000000000002', 'owner'),
  ('f0000010-0016-0016-0016-000000000016', 'd0002716-0006-0006-0006-000000000006', 'a0000003-0003-0003-0003-000000000003', 'owner'),
  ('f0000011-0017-0017-0017-000000000017', 'd0002717-0007-0007-0007-000000000007', 'a0000003-0003-0003-0003-000000000003', 'owner'),
  ('f0000012-0018-0018-0018-000000000018', 'd0002718-0008-0008-0008-000000000008', 'a0000002-0002-0002-0002-000000000002', 'owner'),
  ('f0000013-0019-0019-0019-000000000019', 'd0002719-0009-0009-0009-000000000009', 'a0000004-0004-0004-0004-000000000004', 'owner'),
  ('f0000014-0020-0020-0020-000000000020', 'd0004e20-0000-0000-0000-000000000000', 'a0000003-0003-0003-0003-000000000003', 'owner'),
  ('f0000015-0021-0021-0021-000000000021', 'd0004e21-0001-0001-0001-000000000001', 'a0000003-0003-0003-0003-000000000003', 'owner'),
  ('f0000016-0022-0022-0022-000000000022', 'd0004e22-0002-0002-0002-000000000002', 'a0000004-0004-0004-0004-000000000004', 'owner'),
  ('f0000017-0023-0023-0023-000000000023', 'd0004e23-0003-0003-0003-000000000003', 'a0000003-0003-0003-0003-000000000003', 'owner'),
  ('f0000018-0024-0024-0024-000000000024', 'd0004e24-0004-0004-0004-000000000004', 'a0000002-0002-0002-0002-000000000002', 'owner'),
  ('f0000019-0025-0025-0025-000000000025', 'd0004e25-0005-0005-0005-000000000005', 'a0000003-0003-0003-0003-000000000003', 'owner'),
  ('f000001a-0026-0026-0026-000000000026', 'd0004e26-0006-0006-0006-000000000006', 'a0000003-0003-0003-0003-000000000003', 'owner'),
  ('f000001b-0027-0027-0027-000000000027', 'd0004e27-0007-0007-0007-000000000007', 'a0000003-0003-0003-0003-000000000003', 'owner'),
  ('f000001c-0028-0028-0028-000000000028', 'd0004e28-0008-0008-0008-000000000008', 'a0000004-0004-0004-0004-000000000004', 'owner'),
  ('f000001d-0029-0029-0029-000000000029', 'd0004e29-0009-0009-0009-000000000009', 'a0000002-0002-0002-0002-000000000002', 'owner'),
  ('f000001e-0030-0030-0030-000000000030', 'd0007530-0000-0000-0000-000000000000', 'a0000004-0004-0004-0004-000000000004', 'owner')
ON CONFLICT (id) DO UPDATE SET
