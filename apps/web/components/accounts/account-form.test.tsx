...
describe("AccountForm", () => {
  ...
  describe("required custom-field validation", () => {
    it("shows required indicator for required custom fields", async () => {
      ...
      render(<AccountForm {...defaultProps} fieldDefinitions={requiredFieldDefs} />)
      fireEvent.click(screen.getByText("Create Account"))
      await waitFor(() => {
        expect(screen.getByTestId("cf-required_field")).toBeInTheDocument()
      })
    })

    it("shows error when submitting with empty required custom field", async () => {
