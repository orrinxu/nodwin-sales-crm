...
const FACET_LIST_CLASS =
  "w-full justify-start gap-4 rounded-none border-b border-border bg-transparent p-0"
const FACET_TAB_CLASS =
  "rounded-none border-b-2 border-transparent px-0 py-1.5 text-[13px] data-active:border-primary data-active:bg-transparent data-active:text-foreground data-active:shadow-none"
